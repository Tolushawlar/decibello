...
const JobsPage = () => {
  ...
  const departments = ['All', 'Marketing', 'Data Analytics', 'Design', 'Strategy', 'Operations'];
  const locations = ['All', 'New York', 'London', 'Singapore', 'Sydney', 'Remote'];
                  ...
                  <div className="p-6 md:p-8">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="mt-4 md:mt-0 flex items-center">
                        <span className="text-sm text-dark/50 mr-6">Posted {job.posted}</span>
                        <Link 
